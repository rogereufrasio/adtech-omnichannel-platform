...
Avaliar as principais alternativas de mercado para suportar a evolução da plataforma AdTech da ShopSphere.

A análise considera critérios técnicos, operacionais e estratégicos alinhados aos objetivos da organização.
...
| Governança e Segurança | 20% |
| Custo Total de Propriedade | 15% |
| Maturidade do Fornecedor | 15% |

---

# Customer Data Platform (CDP)

| Fornecedor | Pontuação |
|------------|------------|
| Adobe Experience Platform | 9,4 |
